<div class="container">
    ...
    <div class="infosFooter">
        <div class="infosFooter__reseauxSociaux">
            <h2>Suivez-nous...</h2>
        ...
        <div class="infosFooter__liensUtiles">
            <h2>Liens utiles</h2>
            <ul class="infosFooter__liensUtiles__liste">
    ...
    <small class="credits">Librairie Traces 2019 © Salad-Squad | Tous droits réservés</small>
</div>
