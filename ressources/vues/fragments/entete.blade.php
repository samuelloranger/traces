    ...
    <nav class="navigation navigation__desktop">
        ...
        <div class="conteneurMenu">
            <ul class="conteneurMenu__menu">
                ...
                @if(!$estConnecte == "1")
                    <li class="btnSeConnecter"><a href="index.php?controleur=compte&action=connexion">Se connecter</a>
                    </li>
                @else
                    <li class="btnSeConnecter"><a href="index.php?controleur=compte&action=deconnexion">Déconnexion</a>
                    </li>
                @endif
    ...
    <nav class="navigation navigation__mobile" aria-label="Navigation principale">
        <div class="navigation__mobile__top">
            ...
            <div class="zoneIcones">
                <a href="index.php?controleur=panier&action=panier"
            ...
            <span class="zoneLangue zoneLangue--inactif"><a
                        href="index.php?controleur=accueil&action=index">EN</a></span>
        </div>

        <div class="navigation__mobile__menu navigation__mobile__menu--ferme">
            <h2>Menu</h2>
            <ul class="conteneurMenu__menu">
                <li><a href="index.php?controleur=livre&action=catalogue&categorie=0&trierPar=aucun&nbParPages=9">Catalogue</a>
                </li>
                ...
                @else
                    <li class="btnSeConnecter"><a href="index.php?controleur=compte&action=connexion">Déconnexion</a>
                    </li>
                @endif
            </ul>
        </div>
