...
@section('contenu')
    ...
    <div class="catalogue__categories">
        ...
        <button name="reinitialiser" id="reinitialiser" class="catalogue__categories__reinitialiser">RÉINITIALISER
        </button>
    ...
    <div class="catalogue__rangee--1">
        ...
        <input type="submit" class="catalogue__rechercher__bouton" value="Rechercher">
        <div class="catalogue__nbParPages">
            <p class="catalogue__nbParPages__label">Nombre de livres par pages :</p>
            <a class="catalogue__lien--actif" href="index.php?controleur=livre&action=catalogue&nbParPages=9">9</a>
            <a class="catalogue__lien" href="index.php?controleur=livre&action=catalogue&nbParPages=36">36</a>
            <a class="catalogue__lien" href="index.php?controleur=livre&action=catalogue&nbParPages=72">72</a>
        </div>
    </div>
    <div class="catalogue__rangee--2">
        <p class="catalogue__nbResultatsRecherche">*Nombre de livres trouvées*</p>
        ...
        <div class="catalogue__affichage">
            ...
            <a class="catalogue__affichage__icone--actif" href="index.php?controleur=livre&action=catalogue&affichage=rangees">Rangées</a>
            <a class="catalogue__affichage__icone" href="index.php?controleur=livre&action=catalogue&affichage=cartes">Cartes</a>
        </div>
    </div>
